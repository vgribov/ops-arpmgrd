...
class arpManagerTxnFailTests( HalonTest ):
  ...
  def arp_manager_ovsdb_failure_check_new_updates(self):
    ...
    assert 'failed' in host1v4, "Host 1 192.168.1.2 should be in failed state"
    assert host2v4 == None, "Host 2 192.168.2.2 still in ovsdb"
